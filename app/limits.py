...
BOARD_MAX_COMMENTS_PER_TASK = _get_int("BOARD_MAX_COMMENTS_PER_TASK", 12)
BOARD_MAX_CHILD_TASKS = _get_int("BOARD_MAX_CHILD_TASKS", 3)
BOARD_MAX_REASSIGNMENTS = _get_int("BOARD_MAX_REASSIGNMENTS", 3)
BOARD_CLAIM_TTL_SECONDS = _get_int("BOARD_CLAIM_TTL_SECONDS", 120)
BOARD_AGENT_OFFLINE_AFTER_SECONDS = _get_int("BOARD_AGENT_OFFLINE_AFTER_SECONDS", 90)
BOARD_MAX_TASK_BODY_CHARS = _get_int("BOARD_MAX_TASK_BODY_CHARS", 20000)
BOARD_MAX_COMMENT_CHARS = _get_int("BOARD_MAX_COMMENT_CHARS", 8000)
